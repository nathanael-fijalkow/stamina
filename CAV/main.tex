...
It took another 22 years before an algorithm with a better algrithmic complexity was given by Kirsten.
...
We use an optimization pointed out by Thomas Colcombet \cite{CL08sh}: the structure of Subset Automata, whose algebraic properties allow minimization.
\smallskip
