...
$B$-automata or probabilistic automata. In particular the two frameworks do not seem to be reducible to each other at the level of automata, i.e. there is no encoding of probabilities in counter (or vice-versa) which preserves the stabilization monoid associated with the automaton.