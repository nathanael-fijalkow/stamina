...
% the algorithm proceeds by enumeration of certain expressionsand has a terrible complexity:
...
% To check whether the counter automaton is unbounded, Acme++ computes the associated stabilization monoid.
